        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          >
            <ul className="list-disc space-y-2 pl-5 text-slate-700">
              <li>
                Chapters select Jr.LTF challengers according to the fulfillment of the
                joining requirements (1st assessment). Select Jr.LTF Member according to fulfillment of Entrance standard in 2nd assessment.
              </li>
              <li>
                Then organizers select Jr.LTF Member according to fulfillment of Entrance standard after 2nd assessment Process.
              </li>
              <li>
          ...
          >
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-slate-700">
              <li>1st assessment - Screening process (70-day Spiritual Habit Tracker)</li>
              <li>
                2nd assessment - Summer Challengers' Course, direct input on motivation and
                behavior
              </li>
            </ul>
          </InfoCard>
